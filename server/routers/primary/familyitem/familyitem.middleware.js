...
class FamilyitemMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./familyitem.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./familyitem.policy').acl);
  }


  async default (req, res, next) {

    console.log('Familyitem middleware;')
...
module.exports = FamilyitemMiddleware;